...
export default function Diretor() {
  ...
  return (
    <div className="section-gap animate-fade-in">
      ...
      <QuickGuide 
        storageKey="diretor"
        title="Painel de Gestão: Instruções do Diretor"
        icon={<CheckCircle className="text-brand-blue" size={24} />}
        steps={[
          { text: 'Clique em <strong>"Criar Novo Bloco"</strong> para agrupar as solicitações que serão enviadas para análise técnica.' },
          { text: 'Gere o <strong>Excel ou PDF</strong> do bloco e envie ao avaliador. O status mudará para "Enviado".' },
          { text: 'Ao receber o parecer assinado, use <strong>"Enviar p/ Coordenação"</strong> para anexar o PDF e liberar o fluxo.' }
        ]}
      />
